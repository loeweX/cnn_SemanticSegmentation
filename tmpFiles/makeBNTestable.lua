...
---------------------------------------------------------------------------------
--modelpath = '/rahome/sloewe/torch/myProjects/results_fullconv_rgbd/important/Deconv/2Stage/'
modelpath = '/data/sloewe/results_deconv/Deconv/fullDataset/2Stage/'
model = 'model_50.t7'
epochL = 500
batchSize = 28
...
-- remove last element so that all the batches have equal size
  ...
  for i = 1, #BN_means do
    ...
    BN_vars[i] = BN_vars[i] * (batchSize / (batchSize - 1))
  end
