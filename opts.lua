...
-- global:
  cmd:option('-manualSeed', 1, 'fixed input seed for repeatable experiments') -- 1
...
-- model:
  cmd:option('-netType', 'allShare', 'net type to train: Deconv | FCN | Resnet | ...')
...
--retrain model
  ...
  cmd:option('-retrain', '/data/sloewe/train/allShare/2Stage/model_40.t7', 'provide path to model to retrain with')
...
-- testing?
  cmd:option('-testing', true, 'testing final precision')
