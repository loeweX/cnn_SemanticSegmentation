...
local function bottleneck(n, stride)
  ...
  if layerNum >= 16 and stride == 2 then
...
-- remove first layers of resnet to replace with VGG-layers
model:remove(1)
model:remove(1)
model:remove(1)
model:remove(1)

model:get(1):get(1):get(1):get(1):remove(1)
model:get(1):get(1):get(1):get(1):insert(Convolution(128,64,1,1,1,1,0,0) ,1)

model:get(1):get(1):get(1):get(2):remove(1)
model:get(1):get(1):get(1):get(2):insert(Convolution(128,256,1,1,1,1,0,0) ,1)

-- add first layers of VGG-model
VGGmodel = torch.load("models/ImageNetConv.t7")
...
for i = 1,10 do
  model:insert(VGGmodel:get(i), i)
end

model:insert(SBatchNorm(64),2)
model:insert(SBatchNorm(64),5)
model:insert(SBatchNorm(128),9)
model:insert(SBatchNorm(128),12)
...
--adjust outputsize of last convolution layers
model:get(22):get(3):get(1):get(1):remove(7)
model:get(22):get(3):get(1):get(1):insert(FullConvolution(64,128,1,1,1,1,0,0), 7)
model:get(22):get(3):get(1):get(1):remove(8)
model:get(22):get(3):get(1):get(1):insert(SBatchNorm(128),8)

model:get(22):get(3):get(1):get(2):remove(1)
model:get(22):get(3):get(1):get(2):insert(FullConvolution(256,128,1,1,1,1,0,0), 1)
model:get(22):get(3):get(1):get(2):remove(2)
model:get(22):get(3):get(1):get(2):insert(SBatchNorm(128),2)

--add mirrored VGG-layers
